<div id="policy-shadow" onclick="hidePolicy()">
    <section id="privacy" class="policy">
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to S. World Packaging Supplies, 14950 Miguel Street, El Paso, TX 79928.</p>
            </li>
            <li>
    ...
    <section id="shipping" class="policy">
        ...
        <p>Thank you for shopping at S. World Packaging Supplies. All orders from S. World Packaging Supplies are subject to our shipping policy, outlined below. If you have any questions about our shipping practices, please contact our dedicated support team at customerservice@hworldpackaging.com.</p>

        <h2 id="where-we-ship">Where We Ship</h2>


        <p>S. World Packaging Supplies offers shipping to all mainland U.S. states. We don’t ship to Alaska or Hawaii at this time.</p>



        <h3 id="processing">Processing</h3>
        <p>We process orders during our normal business hours.</p>
        <p>You are responsible for all return shipping fees. Shipping fees are non-refundable. S. World Packaging Supplies strongly recommends that you use a trackable method to ship your return. </p>
        <p>We make every effort to fulfill orders as quickly as possible, but sometimes life throws us a curveball. (Ahem, Covid-19.) If we are experiencing longer than usual processing times, we will notify you either on our site or by email.</p>

        <h3 id="shipping-rates-and-timing">Shipping Rates & Timing</h3>

        <p>S. World Packaging Supplies has multiple shipping rates, depending on either the product or the shipping method chosen. The shipping charge will be calculated and displayed during checkout. An estimate of the time it takes to deliver your order will be provided on our website. Please remember that the time it takes to process your order is a separate estimate from the time it takes to ship and deliver your order.</p>
        ...
        <p>First, we sincerely apologize for the inconvenience this may have caused. We want your experience at http://www.hworldpackaging.com to be positive. If your order has arrived damaged, or has been stolen or lost in transit, please contact us at customerservice@hworldpackaging.com immediately so we can look into the matter for you.</p>

        <h3 id="how-to-contact-us">How to Contact Us</h3>
        <p>If you have any questions or concerns regarding your order or the shipping options available, please contact us at customerservice@hworldpackaging.com.</p>
